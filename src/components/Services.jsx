      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="p-6 hover:shadow-lg transition-shadow duration-300 bg-gray-800 text-white border-gray-700">
              <h3 className="text-xl font-semibold mb-4 text-teal-400">{service.title}</h3>
