  ...
  return (
    <div className="relative bg-gray-900 text-white py-20">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Transforming Businesses with AI Solutions in South Africa</h1>
        <p className="text-xl md:text-2xl mb-4">Offering AI Automation, Web Applications, Employee Training, and More</p>
        <p className="text-lg md:text-xl mb-8 font-semibold text-teal-300">Save Time, Money, and Boost Productivity with AI Solutions</p>
        <Button 
